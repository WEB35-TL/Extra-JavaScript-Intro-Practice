...
const dollarsToEuros = usd => usd * 0.85
...
const moneyConversion = (dollarAmount, country) => {
  let euro = 0.85,
    pounds = 0.77,
    lira = 6.96,
    lev = 1.66,
  ...
  if (country === 'Britain') {
    return `Your exchange rate for $${dollarAmount} in ${country} will be ${
      dollarAmount * euro
    } `
  }
  if (country === 'Germany') {
  ...
  if (country === 'Bulgaria') {
    return `Your exchange rate for $${dollarAmount} in ${country} will be ${Math.round(
      dollarAmount * lev
    )} `
  }
  if (country === 'Ukraine') {
    return `Your exchange rate for $${dollarAmount} in ${country} will be ${
      dollarAmount * hryvnia
    } `
  } else {
    return `Please enter the required arguments.`
  }
}

console.log(moneyConversion(10, 'Britain'))
console.log(moneyConversion(10, 'Germany'))
console.log(moneyConversion(10, 'Turkey'))
console.log(moneyConversion(10, 'Bulgaria'))
console.log(moneyConversion(10, 'Ukraine'))
...
console.log(airportCodes('AAA'))

/*TASK 4 🚀 
// Write a function to that will find the phone number for an airport in a given city  */

const phoneNumber = city => {
  for (let i = 0; i < airports.length; i++) {
    if (airports[i].city === city) {
      return `The phone number for ${city} is ${
        airports[i].phone ? airports[i].phone : '0'
      }`
    }
  }
...
console.log(phoneNumber('Abadan'))
console.log(phoneNumber('Allentown'))
console.log(phoneNumber(''))

/*TASK 5 🚀 
// Write a function that will return all the airports in a given country  */

const allAirports = country => {
  let air = []
...
console.log(airportNames('Al Baha Airport'))
console.log(airportNames('Ambler Airport'))
console.log(airportNames('Abuja International Airport'))

/*TASK 7 🚀
// Write a function that takes an airport code and returns the number of direct flights available */

const directFlights = code => {
  for (let i = 0; i < airports.length; i++) {
    if (airports[i].code === code) {
